...
<div class="container">
	...
	<div class="col-sm-12">
		@if ($sims == 'alle')
		<form role="form" method="POST" action="{{ route('sync.ps.sync_class') }}">
		@endif
		@if ($sims == 'oneplus')
		<form role="form" method="POST" action="{{ route('sync.js.sync_class') }}">
		@endif
		@if ($sims == 'bridge')
		<form role="form" method="POST" action="{{ route('sync.hs.sync_class') }}">
		@endif
		@csrf

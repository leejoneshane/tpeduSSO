		...
		<div class="panel-body">
			<div class="form-group">
				<dl class="dl-horizontal">
					...
					<dd>身分證字號，是單一資料。</dd>
					<dt>o</dt>
					<dd>學校代號，若身分為學生，是單一資料；若身分為教師，則允許多筆資料，請使用陣列表示法（詳見通則）。預設為各級學校網域名稱。教育局使用 bureau。</dd>
					<dt>type</dt>
					<dd>身分別，是單一資料。右列擇一：教師、學生、校長、職工、主官管。</dd>
					<hr>
					<dt>若身分是學生，須包含：</dt>
					<dd>
						<dt>stdno</dt>
					...
					<hr>
					<dt>character</dt>
					<dd>特殊身分註記，是單一資料。請使用中文描述，若有多重特殊身分，請中間用半形空白隔開，若無特殊身分可省略。</dd>
					<dt>sn</dt>
					<dd>姓氏，是單一資料。</dd>
					<dt>gn</dt>
					<dd>名字，是單一資料。</dd>

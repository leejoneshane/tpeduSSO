	...
	@endif
		...
		<div class="panel-default">	  
			<div class="panel-heading">
				<a href="#addSchoolClassModal" class="btn btn-success" data-toggle="modal" style="float: right;margin-top: 3px;">
						...
						<tr>
							...
							<td>
								...
								<button type="button" class="btn btn-danger"
									onclick="if(confirm('確定要刪除『'+$(this).parent().parent().find(':text').val()+'』?')){$('#remove-form').attr('action','{{ route('school.removeClass', [ 'dc' => $dc, 'ou' => $class->ou ]) }}');

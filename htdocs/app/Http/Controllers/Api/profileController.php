...
class profileController extends Controller
{
	...
	if ($json->role == '學生') {
	    ...
	    if (array_key_exists('department', $user->ldap)) $json->unit = $user->ldap['department'][$o][0];
	    if (array_key_exists('titleName', $user->ldap)) $json->title = $user->ldap['titleName'][$o][0];
	    if (array_key_exists('teachClass', $user->ldap)) $json->teachClass = $user->ldap['teachClass'][$o];
	}
